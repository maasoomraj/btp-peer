      ...
      <div className="App">
        ...
        <div>
          <p className="homeTitle">
            Hello {this.state.userDB.name ? this.state.userDB.name : "User"}{" "}
            (Phone -{" "}
            {this.state.userDB.phone ? this.state.userDB.phone : "0000000000"})
          </p>
        </div>
        <br />
        ...
        <div className="walletInfo">
          <p className="walletInfoText">
            Your Address:{" "}
            {address ? address.substring(0, 20) + "..." : " Loading.... "}
            <br />
